...
[← 返回总览](README.md) · 🌐 [English](./by-fbi_en.md)

> 共 **56** 条记录（PDF 48 · 图片 8）

## 目录

- [FBI 提交的不明飞行物报告（32）](#fbi-提交的不明飞行物报告)
- [FBI 62-HQ-83894 案卷（1947–1968）（18）](#fbi-62-hq-83894-案卷19471968)
- [FBI 302 询问记录（2023 年 9 月目击）（3）](#fbi-302-询问记录2023-年-9-月目击)
- [其他记录（3）](#其他记录)
...
> 美国联邦调查局（FBI）向全域异常现象解决办公室（AARO）提交了一份关于不明异常现象（UAP）的报告，内容为来自美国政府系统的一帧静止图像。事件的日期与地点未提供。该原始图像在提交给 AARO 之前经过了删改处理，未附带任务报告。执行者报告称无法对该 UAP 进行确切识别。叙述性描述：该单色图像背景呈均匀、带颗粒感的纹理，中央带有十字准星。一个小而暗、形状略不规则的物体位于准星正中心略偏右下方。本叙述性描述仅供参考，读者不应将本描述的任何部分理解为对所述事件的真实性、性质或意义的分析判断、调查结论或事实认定。
...
## FBI 62-HQ-83894 案卷（1947–1968）

> 共 **18** 条记录共享同一段简介。

> FBI 案卷 62-HQ-83894 收录了 1947 年 6 月至 1968 年 7 月间有关「不明飞行物」和「飞碟」的调查档案、目击证词及公众报告。档案内容涵盖重大事件记录、来自田纳西州橡树岭等地的影像证据，以及关于潜在推进系统的技术提案；此外还包含相关大会议程、研究人员陈述以及当时大量的媒体报道。此案卷已部分发布于 FBI Vault 网站，但删改更多、并有页面缺失。本次发布的是完整的案卷，新解密了多页内容，且仅有少量删改。
...
### 1. 65_HS1-834228961_62-HQ-83894_Section_10
...
## FBI 302 询问记录（2023 年 9 月目击）

> 共 **3** 条记录共享同一段简介。

> 本文件为 FBI 对一名美国公民的「302 表」访谈记录，内容是其亲历的一次发生在某美国测试场地的 UAP 遭遇。该美国公民（USPER）将所见物体描述为「金属铜色」。
...
### 158. FBI September 2023 Sighting - Serial 3

📄 PDF · 机构 FBI（美国联邦调查局） · 发布 5/8/26 · 事件 9/1/23 · 地点 美国 · 删改 是
...
### 31. 65_HS1-101634279_100-DE-18221_Serial_844

📄 PDF · 机构 FBI（美国联邦调查局） · 发布 5/8/26 · 事件 4/17/58 · 地点 美国密歇根州底特律 · 删改 未标注

> 1958 年的一份 FBI 备忘录，记录一名底特律男子目击 UFO 的情况，他描述其为「带水晶状穹顶的圆形物体」，并建议将该情报转交「相应的空军部门」。
...
📄 PDF · 机构 FBI（美国联邦调查局） · 发布 5/8/26 · 事件 11/7/57 · 地点 德国 · 删改 是

> 1957 年的一份 FBI 报告，详细记录了对 Wladyslaw Krasuski 的访谈。他回忆称 1944 年在德国一处德军军事设施附近，目击了一架体型庞大、呈圆形、垂直升起的飞行器。
...
📄 PDF · 机构 FBI（美国联邦调查局） · 发布 5/8/26 · 事件 9/1/23 · 地点 美国 · 删改 未标注

> 现场实拍照片，叠加由 FBI 实验室渲染的图形示意。该图形依据 2023 年 9 月多名目击者的相互印证报告，描绘了一个椭球形铜色金属物体在天空中一道强光中显现、长 40–60 米（130–195 英尺）、随即在瞬间消失的情景。
